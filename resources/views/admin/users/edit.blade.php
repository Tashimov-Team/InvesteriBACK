...
<div class="min-h-screen flex items-center justify-center">
    <div class="bg-white rounded-lg shadow-xl p-8 w-full max-w-md">
        <form action="{{ route('admin.users.update', $user) }}" method="POST">
            ...
            <div class="mb-6">
                <label for="email" class="block text-sm font-medium text-gray-700 mb-2">Телефон</label>
                <input
                    value="{{ $user->phone }}"
                    type="phone"
                    id="phone"
            ...
            <div class="mb-6">
                <label for="email" class="block text-sm font-medium text-gray-700 mb-2">ИНН</label>
                <input
                    value="{{ $user->inn }}"
                    type="inn"
                    id="inn"
